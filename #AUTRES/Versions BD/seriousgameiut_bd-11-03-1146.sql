...
--
-- Hôte : mysql-seriousgameiut.alwaysdata.net
-- Généré le :  lun. 11 mars 2019 à 11:42
...
--
-- Base de données :  `seriousgameiut_bd`
--
CREATE DATABASE IF NOT EXISTS `seriousgameiut_bd` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `seriousgameiut_bd`;
...
--
-- Déchargement des données de la table `association_ip_pc`
--
